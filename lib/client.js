...
current: null };
		...
		*/
		...
		//#endregion
		//#region src/client/ResearchQuickStartDock.tsx
		...
		function ResearchQuickStartDock({ inputActions }) {
			return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", {
					...
					children: "科研快速开始"
				}), workflows.map(([label, prompt]) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					type: "button",
					style: button,
					onClick: () => {
